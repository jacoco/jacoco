...
public final class ProbeDoubleIntArray implements
	...
	public char getFormatVersion() {
		return ExecutionDataWriter.FORMAT_DOUBLEINT_VERSION;
	}
	...
	public void write(final char formatVersion, final CompactDataOutput output)
			throws IOException {
		if (formatVersion != ExecutionDataWriter.FORMAT_DOUBLEINT_VERSION) {
			throw new IOException(
					"Unable to write double-int probes in format 0x"
