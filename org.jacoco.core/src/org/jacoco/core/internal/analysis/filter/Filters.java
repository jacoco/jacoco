...
public final class Filters implements IFilter {
	...
	public static IFilter all() {
		return new Filters(new EnumFilter(), new SyntheticFilter(),
				...
				new PlainGetterAndSetterFilter(), new StringSwitchJavacFilter(),
				new StringSwitchEcjFilter(), new EnumEmptyConstructorFilter(),
				new RecordsFilter(), new AnnotationGeneratedFilter(),
