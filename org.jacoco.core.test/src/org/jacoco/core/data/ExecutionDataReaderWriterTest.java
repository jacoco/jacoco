...
public class ExecutionDataReaderWriterTest {
	...
	public static class ExecutionDataReaderWriterExistsTest extends
		...
		public ExecutionDataReaderWriterExistsTest() {
	...
	public static class ExecutionDataReaderWriterCountTest extends
			ExecutionDataReaderWriterTestBase {
		public ExecutionDataReaderWriterCountTest() {
			formatVersion = ExecutionDataWriter.FORMAT_INT_VERSION;
		}
	...
	public static class ExecutionDataReaderWriterParallelTest extends
			ExecutionDataReaderWriterTestBase {
		public ExecutionDataReaderWriterParallelTest() {
			formatVersion = ExecutionDataWriter.FORMAT_DOUBLEINT_VERSION;
		}
	...
	public static abstract class ExecutionDataReaderWriterTestBase {
		...
		public void testGetFileHeader() {
			byte[] header = ExecutionDataWriter.getFileHeader(new HeaderInfo(
					formatVersion));
			...
			final char version = formatVersion;
		...
		public void testInvalidHeaderVersion() throws IOException {
			...
			buffer.write(0xC0);
			buffer.write(0xC0);
			final char version = ExecutionDataWriter.FORMAT_VERSION_UNKNOWN;
		...
		public void testMissingHeader() throws Exception {
			buffer.reset();
			Field headerWrittenField = ExecutionDataWriter.class
					.getDeclaredField("headerWritten");
			headerWrittenField.setAccessible(true);
			headerWrittenField.set(writer, Boolean.TRUE);
