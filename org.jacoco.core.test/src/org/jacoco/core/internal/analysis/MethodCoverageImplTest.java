...
public class MethodCoverageImplTest {
	...
	public void testIncrementMissedInstructions() {
		...
		node.increment(CounterImpl.getInstance(25, 0, 0), CounterImpl.COUNTER_0_0, 3);
	...
	public void testIncrementComplexity2() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(2, 0, 0),
				3);
		assertEquals(CounterImpl.getInstance(1, 0, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity3() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(1, 1, 1),
				3);
		assertEquals(CounterImpl.getInstance(1, 0, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity4() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(0, 2, 2),
				3);
		assertEquals(CounterImpl.getInstance(0, 1, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity5() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(3, 0, 3),
				3);
		assertEquals(CounterImpl.getInstance(2, 0, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity6() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(2, 1, 1),
				3);
		assertEquals(CounterImpl.getInstance(2, 0, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity7() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(1, 2, 2),
				3);
		assertEquals(CounterImpl.getInstance(1, 1, 0), node.getComplexityCounter());
	}
	...
	public void testIncrementComplexity8() {
		MethodCoverageImpl node = new MethodCoverageImpl("sample", "()V", null,
				ProbeMode.exists);
		node.increment(CounterImpl.COUNTER_0_0, CounterImpl.getInstance(0, 3, 3),
				3);
		assertEquals(CounterImpl.getInstance(0, 2, 0), node.getComplexityCounter());
	}
}
