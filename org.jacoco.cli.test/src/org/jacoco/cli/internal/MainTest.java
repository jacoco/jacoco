...
public class MainTest extends CommandTestBase {
	...
	public void should_not_print_error_message_when_parent_file_of_xml_does_not_exist() throws Exception {
		execute("report",
				"jacoco_demo\\target\\jacoco_tcp_02.exec",
				"--classfiles",
				"jacoco_demo\\target\\classes",
				"--sourcefiles",
				"jacoco_demo\\src\\main\\java",
				"--html",
				"report02_test_1100",
				"--xml",
				"report02_test_1100\\xml\\jacoco.xml",
				"--name",
				"Report02_test_1100");

		assertOk();
		assertNoOutput(err);
		assertContains("Loading execution data file", out);
		assertContains("Analyzing 2 classes", out);
	}

	@Test
	public void should_not_print_error_message_when_parent_file_of_xml_exists() throws Exception {
		execute("report",
				"jacoco_demo\\target\\jacoco_tcp_02.exec",
				"--classfiles",
				"jacoco_demo\\target\\classes",
	...
	@Test
	public void should_not_print_error_message_when_parent_file_of_csv_does_not_exist() throws Exception {
		execute("report",
				"jacoco_demo\\target\\jacoco_tcp_02.exec",
				"--classfiles",
				"jacoco_demo\\target\\classes",
				...
				"report02_test_1100",
				"--csv",
				"report02_test_1100\\csv\\jacoco.csv",
				"--name",
				"Report02_test_1100");
	...
	@Test
	public void should_not_print_error_message_when_parent_file_of_csv_exists() throws Exception {
		execute("report",
				"jacoco_demo\\target\\jacoco_tcp_02.exec",
				"--classfiles",
				"jacoco_demo\\target\\classes",
